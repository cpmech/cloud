...
describe('cloneSimple', () => {
  it('the copy should be equal to the original object', () => {
    expect(cloneSimple(obj1)).toEqual(obj1);
    expect(cloneSimple(obj2)).toEqual(obj2);
    expect(cloneSimple(obj3)).toEqual(obj3);
